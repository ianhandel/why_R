...
library(pander) # to highlight rows
...
```{r}
DATA_FILE_NAME <- "../data/ians-drug-trial_biochemistry-results_20171020.xlsx"
...
```{r}
write_csv(dat, "../data/ians-drug-trial_biochemistry-results_20171020_tidied.csv")
```
